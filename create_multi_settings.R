...
SDA_run_dir <- "/projectnb/dietzelab/guYANG/pecan/runners/wishart_sda/output/run/"
SDA_out_dir <- "/projectnb/dietzelab/guYANG/pecan/runners/wishart_sda/output/out/"

ERA5_dir <- "/projectnb/dietzelab/dongchen/anchorSites/NA_runs/ERA5_2012_2024/"
XML_out_dir <- "/projectnb/dietzelab/guYANG/pecan/runners/wishart_sda/output/pecan.xml"

pft_csv_dir <- "/projectnb/dietzelab/dongchen/anchorSites/NA_runs/site_pft.csv"
modis_phenology_dir <- "/projectnb/dietzelab/dongchen/anchorSites/NA_runs/MODIS_Phenology/leaf_phenology.csv"
...
obs_outdir <- "/projectnb/dietzelab/guYANG/pecan/runners/wishart_sda/output/Obs"
...
template <- PEcAn.settings::Settings(list(
  ...
  state.data.assimilation = structure(list(
    ...
    state.variables = structure(list(
      ...
      variable = structure(list(variable.name = "SoilMoistFrac", unit = "", min_value = 0, max_value = 100)),#soilWFracInit
