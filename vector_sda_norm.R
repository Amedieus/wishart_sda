...
settings$outdir <- "/projectnb/dietzelab/guYANG/pecan/runners/wishart_sda/output_inter_q_4/"
...
settings$rundir <- "/projectnb/dietzelab/guYANG/pecan/runners/wishart_sda/output_inter_q_4/run"
